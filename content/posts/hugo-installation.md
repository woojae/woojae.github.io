...
Here’s a step-by-step explanation of how I created my website using Hugo and deployed it to GitHub Pages.  Mostly created this page for personal reference. The full source code for the website can be found on [here](https://github.com/woojae/woojae.github.io).
